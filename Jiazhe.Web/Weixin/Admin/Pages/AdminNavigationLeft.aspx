<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminNavigationLeft.aspx.cs" Inherits="Jiazhe.Web.Weixin.Admin.Pages.AdminNavigationLeft" %>
...
<dl class="list_dl">
        ...
        <dd class="list_dd">
            <ul>
                <li class="list_li"><a href="WeixinPublicNumber.aspx" target="updoun">微信公众号</a></li>
