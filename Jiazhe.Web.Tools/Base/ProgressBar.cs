...
namespace Jiazhe.Web.Tools.Base
{
    public class ProgressBar : System.Web.UI.Page
    {
        ...
        public void SetThisValue(int intThisValue)
        {
            ThisValue = intThisValue;
            ViewState["ThisValue"] = 0;
        }
        ...
        public void InitProgress()
        {
            ...
            string templateFileName = AppDomain.CurrentDomain.BaseDirectory + "Manager\\Pages\\ProgressBar.html";
        ...
        {
            string strjsBlock = "<script>SetHeader('" + strHeader + "'); </script>";
        ...
        {
            string strjsBlock = "<script>SetProgressBarWidth('" + Width + "'); </script>";
